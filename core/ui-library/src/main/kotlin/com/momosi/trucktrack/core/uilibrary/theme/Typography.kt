...
internal val TruckTrackTypography =
    Typography(
        ...
        titleLarge = TextStyle(fontWeight = FontWeight.Medium, fontSize = 18.sp, lineHeight = 28.sp, letterSpacing = 0.sp),
...
@Immutable
data class TruckTrackTypographyStyles(
...
internal fun Typography.toTruckTrackTypographyStyles() = TruckTrackTypographyStyles(
...
internal val LocalTruckTrackTypography = staticCompositionLocalOf { TruckTrackTypography.toTruckTrackTypographyStyles() }
